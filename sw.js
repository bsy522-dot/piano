const CACHE_NAME = 'piano-master-v30';
const ASSETS = [
  './',
  './index.html',
  './piano-v3.html',
    ...
    e.respondWith(
      fetch(e.request).then(res => {
        ...
        return res.text().then(html => {
          ...
          if (!html.includes('v22_patch.js') && html.includes('</body>')) {
            html = html.replace('</body>', '<script src="v22_patch.js"></script></body>');
          }
          if (!html.includes('v23_patch.js') && html.includes('</body>')) {
            html = html.replace('</body>', '<script src="v23_patch.js"></script></body>');
          }
          if (!html.includes('v24_patch.js') && html.includes('</body>')) {
            html = html.replace('</body>', '<script src="v24_patch.js"></script></body>');
          }
          if (!html.includes('v25_patch.js') && html.includes('</body>')) {
            html = html.replace('</body>', '<script src="v25_patch.js"></script></body>');
          }
          if (!html.includes('v26_patch.js') && html.includes('</body>')) {
            html = html.replace('</body>', '<script src="v26_patch.js"></script></body>');
          }
          if (!html.includes('v27_patch.js') && html.includes('</body>')) {
            html = html.replace('</body>', '<script src="v27_patch.js"></script></body>');
          }
          if (!html.includes('v28_patch.js') && html.includes('</body>')) {
            html = html.replace('</body>', '<script src="v28_patch.js"></script></body>');
          }
          if (!html.includes('v29_patch.js') && html.includes('</body>')) {
            html = html.replace('</body>', '<script src="v29_patch.js"></script></body>');
          }
          if (!html.includes('v30_patch.js') && html.includes('</body>')) {
            html = html.replace('</body>', '<script src="v30_patch.js"></script></body>');
          }
